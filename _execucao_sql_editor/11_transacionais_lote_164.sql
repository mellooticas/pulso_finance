...
-- Conciliação - PIX RECEBIDO - GABRIELA DE BRITO LOP...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- HONORÁRIOS: Bruna Giovanna Cardoso > Parcela 5/8 >...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - MIRIAN BOMFIM...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ACORDO: Bruna Giovanna Cardoso > Parcela 3/12 > PI...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - VERONICA MIRANDA DE F...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX ENVIADO - ESPEED IMPORTACAO E EI...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - VANESSA PEREIRA DOS S...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Lote 71/86 (500 lançamentos)

-- Conciliação - QR CODE PIX RECEBIDO - WILFRID FLERI...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX ENVIADO - SANTA HELENA D...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - MANOEL LIBERATI DE JE...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - VIVIANE MARIA...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'Conciliação - QR CODE PIX RECEBIDO - VIVIANE MARIA ALVES LERIN',
        'Conciliação - QR CODE PIX RECEBIDO - VIVIANE MARIA ALVES LERIN',
        '2024-09-12'::date,
        1600.0,
        1,
...
-- Conciliação - QR CODE PIX RECEBIDO - LARISSA MARIA...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ACORDO: VISION PRIME - Parcela 15/49 > PIX: 47.392...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- MANUTENÇÃO ELÉTRICA: Nicolas Emanuel Milantez > PI...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - GABRIEL LUIZ ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CIBELE CRISTINA G S A...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - ELZA DOS REIS...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- SALÁRIO: Sarah Beatriz (ref. 01/08, 27/08 e 28/07/...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ACORDO: ACERTO FRANQUIA > Parcela 29/40 > PIX: 39....
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - MAGNO FIGUEIR...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- SALÁRIO: Normando Ferreira da Silva Filho (ref. 26...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- TROCO (estorno): Maria Elizabeth Pereira do Nascim...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ACORDO > ALUGUEL MAUÁ- Loja (ref. ) > parcela 8/10...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO > ALUGUEL MAUÁ- Loja (ref. ) > parcela 8/10 > BANCO: Bradesco | Agência: 2229 | Conta Corrente: 1433-8',
        'ACORDO > ALUGUEL MAUÁ- Loja (ref. ) > parcela 8/10 > BANCO: Bradesco | Agência: 2229 | Conta Corrente: 1433-8',
        '2024-09-16'::date,
        1093.7,
        1,
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO > ALUGUEL MAUÁ - Clínica (ref. ) > parcela 8/10 > BANCO: Bradesco | Agência: 2229 | Conta Corrente: 1433-8',
        'ACORDO > ALUGUEL MAUÁ - Clínica (ref. ) > parcela 8/10 > BANCO: Bradesco | Agência: 2229 | Conta Corrente: 1433-8',
        '2024-09-16'::date,
        1093.7,
        1,
...
-- Conciliação - PIX RECEBIDO - BRUNO LEONARDO SOUZA ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- VALE TRANSPORTE: Mike Rodrigues Gomes (bilhete QR ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- INSTITUTO VISÃO:  1° Quinz. Setembro > PIX: 35.128...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
