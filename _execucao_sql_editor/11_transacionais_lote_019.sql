...
-- PRO-LABORE TATY -  KAMIX FOODS IND E         ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- PIX - RECEBIDO -  00028612984807 GISELE MOUR...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- PIX - RECEBIDO -  00048076312841 GABRIELA JO...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- PRO-LABORE TATY -  PANIF E CONF QUEL         ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- PRO-LABORE TATY - GILBERTO DE CAMARGO SILVA JUNIOR...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- COMBUSTIVEL - AUTO POSTO DE SUZANO...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ALMOcO -  SABORES DA TERRA SUZANO ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- PRO-LABORE JUNIOR - FONE GIOVANNA...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- PRO-LABORE TATY -  BG LESTE ALIMENTOS        ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- PRO-LABORE JUNIOR - WILLIAN SAIRESDO...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
