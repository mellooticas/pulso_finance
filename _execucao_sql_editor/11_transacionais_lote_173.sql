...
-- Conciliação - PIX RECEBIDO - SILAS RODRIGUES FARNE...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'FUNDO DE GARANTIA DO TEMPO DE SERVIÇO (competência 10/2024)',
        'FUNDO DE GARANTIA DO TEMPO DE SERVIÇO (competência 10/2024)',
        '2025-10-18'::date,
        348.47,
        1,
...
-- COFINS: Simples Nacional 03/2023 - Parcela 12/18...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- CSLL: Simples Nacional 03/2023 - Parcela 12/18...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- PIS: Simples Nacional 03/2023 - Parcela 12/18...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'FUNDO DE GARANTIA DO TEMPO DE SERVIÇO (competência 08/2023) - Maria da Conceição Ramos de Moura',
        'FUNDO DE GARANTIA DO TEMPO DE SERVIÇO (competência 08/2023) - Maria da Conceição Ramos de Moura',
        '2025-10-18'::date,
        171.03,
        1,
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'FUNDO DE GARANTIA DO TEMPO DE SERVIÇO (competência 06/2023) - Maria da Conceição Ramos de Moura',
        'FUNDO DE GARANTIA DO TEMPO DE SERVIÇO (competência 06/2023) - Maria da Conceição Ramos de Moura',
        '2025-10-18'::date,
        173.11,
        1,
...
-- IRPJ: Simples Nacional 03/2023 - Parcela 12/18...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'FUNDO DE GARANTIA DO TEMPO DE SERVIÇO (competência 01/2024) - Maria da Conceição Ramos de Moura',
        'FUNDO DE GARANTIA DO TEMPO DE SERVIÇO (competência 01/2024) - Maria da Conceição Ramos de Moura',
        '2025-10-18'::date,
        174.93,
        1,
...
-- INSS: Simples Nacional 03/2023 - Parcela 12/18...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'FUNDO DE GARANTIA DO TEMPO DE SERVIÇO (competência 02/2024) - Maria da Conceição Ramos de Moura',
        'FUNDO DE GARANTIA DO TEMPO DE SERVIÇO (competência 02/2024) - Maria da Conceição Ramos de Moura',
        '2025-10-18'::date,
        174.13,
        1,
...
-- ICMS: Simples Nacional 03/2023 - Parcela 12/18...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- RESCISÃO: Zaine de Lima Siqueira - Acordo 3/14 > P...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'RESCISÃO: Zaine de Lima Siqueira - Acordo 3/14 > PIX: 275.783.178-06 (CPF)',
        'RESCISÃO: Zaine de Lima Siqueira - Acordo 3/14 > PIX: 275.783.178-06 (CPF)',
        '2024-11-21'::date,
        1250.0,
        1,
...
-- RESCISÃO: Ariani Dias Fernandes Líbano - Acordo 2/...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- VALE TRANSPORTE: Cleberson Ribeiro de Jesus > PIX:...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'VALE ADIANTAMENTO: Thiago Yuri da Silva Yuki > PIX: yukicomercial@gmail.com (e-mail)',
        'VALE ADIANTAMENTO: Thiago Yuri da Silva Yuki > PIX: yukicomercial@gmail.com (e-mail)',
        '2024-11-21'::date,
        1200.0,
        1,
...
-- Conciliação - QR CODE PIX RECEBIDO - ANA LUCIA DA ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - DENISE MARIA ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - DOURIVAL CLEM...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ACORDO: ACERTO FRANQUIA > Parcela 9/54 > PIX: 39.4...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ACORDO: ACERTO FRANQUIA > Parcela 39/40 > PIX: 39....
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - MARIA ANTONIA DA SILV...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'Conciliação - PIX RECEBIDO - MARIA ANTONIA DA SILVA',
        'Conciliação - PIX RECEBIDO - MARIA ANTONIA DA SILVA',
        '2024-11-22'::date,
        1000.0,
        1,
...
-- Conciliação - PIX RECEBIDO - VITOR FRANCISCO DA SI...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - MICAELE APARECIDA DOS...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - ARNALDO BARBO...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- IRPJ: Simples Nacional 03/2023 - Parcela 13/18...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - PAULA VITORIA OLIVEIR...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- INSS: Simples Nacional 03/2023 - Parcela 13/18...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ICMS: Simples Nacional 03/2023 - Parcela 13/18...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- COFINS: Simples Nacional 03/2023 - Parcela 13/18...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- CSLL: Simples Nacional 03/2023 - Parcela 13/18...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- PIS: Simples Nacional 03/2023 - Parcela 13/18...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - ROGERIO APARECIDO DE ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - ANDERSON RAFA...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - INDAIARA CÉLIA DOS SA...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
