...
-- MERCADO - BISCOITO ADRIA AGUA E SAL...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- PIX - RECEBIDO -  00043739152885 ELIZABETH M...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- COMPRAS PARA LOJA - FOLHAS DE SULFITE...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- PIX - RECEBIDO -  00029888881833 CAMILA DE P...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- PIX - RECEBIDO -  00006949260199 ELIZANDRA M...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ALMOcO -  PASTELARIA ERENITO SUZAN...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- PIX - RECEBIDO -  00043003086839 DANIELLE YU...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- COMPRAS PARA LOJA - ARRUELA LISA...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- PIX - RECEBIDO -  00066217016834 SONIA MARIA...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- PAPELARIA - FITA FIXA FORTE TRANSPARENTE...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- VENDAS DINHEIRO - 973: DARI DOS SANTOS...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- PRO-LABORE TATY -  RODOANEL LESTE            ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- PIX - RECEBIDO -  00034071617861 ROBSON LEON...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
