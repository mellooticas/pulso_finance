...
-- PIX - RECEBIDO - 60701190 00009262361807 EMERSON A...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'PIX - RECEBIDO - 60701190 00009262361807 EMERSON A SOAR',
        'PIX - RECEBIDO - 60701190 00009262361807 EMERSON A SOAR',
        '2020-12-29'::date,
        1000.0,
        1,
...
-- PIX - RECEBIDO - 00000000 34089654000155 THAIS G 4...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'PIX - RECEBIDO - 00000000 34089654000155 THAIS G 421745',
        'PIX - RECEBIDO - 00000000 34089654000155 THAIS G 421745',
        '2020-12-29'::date,
        246.0,
        1,
