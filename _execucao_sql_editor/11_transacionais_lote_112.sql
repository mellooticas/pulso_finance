...
-- TAXA DE FISCALIZAÇÃO DE ESTABELECIMENTO - ref. 06/...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO INTERNO - 00019 0289284...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :60701190-ELAINE M...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :17192451-TATIANA ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO INTERNO - 00019 0063827...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'Conciliação - PIX RECEBIDO INTERNO - 00019 0063827107 ROGERIO DUARTE',
        'Conciliação - PIX RECEBIDO INTERNO - 00019 0063827107 ROGERIO DUARTE',
        '2023-07-11'::date,
        1000.0,
        1,
...
-- 12/06/2023 - BRASLAB PRODUTOS OTICOS EIRELI...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :00000000-NEUZA F ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ANUIDADE CLIENTE: Marcos Luiz Serafim - Parcela 3/...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'Compra da loja - Óticas Taty Mello: Parcela 7/11 - 2',
        'Compra da loja - Óticas Taty Mello: Parcela 7/11 - 2',
        '2023-07-12'::date,
        2090.9,
        1,
...
-- PROMOÇÃO QUEM INDICA AMIGO É!: OS 2238 - Vera Luci...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX - RECEBIDO12/07 16:43 0004139072...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- VALE TRANSPORTE: Wellen Santos Silva (adiantamento...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- PROMOÇÃO QUEM INDICA AMIGO É!: OS 3497 - Helen da ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- FAST COMPANY ARMAÇÕES E LENTES LTDA - Parcela 2/22...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'FAST COMPANY ARMAÇÕES E LENTES LTDA - Parcela 2/22 (compra da loja + rescisão Karina)',
        'FAST COMPANY ARMAÇÕES E LENTES LTDA - Parcela 2/22 (compra da loja + rescisão Karina)',
        '2023-07-13'::date,
        2200.0,
        1,
...
-- SALÁRIO: Pâmela de Oliveira Santos (divulgadora, r...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- MARCELLY: Embalagens - Parcela 4/7...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX ENVIADO - CP :18236120-GILBERTO ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'SERVIP SERVIÇOS P LTDA ME: Instalação das câmeras - Parcela 2/6 - 11) 9 5139-6200',
        'SERVIP SERVIÇOS P LTDA ME: Instalação das câmeras - Parcela 2/6 - 11) 9 5139-6200',
        '2023-09-05'::date,
        1040.0,
        1,
...
-- VALE TRANSPORTE: Pâmela de Oliveira Santos (ref. 2...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX - RECEBIDO14/07 12:20 1210924700...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :22896431-MARCIO H...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- 15/06/2023 - BRASLAB PRODUTOS OTICOS EIRELI...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :00000000-MARIA LU...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
