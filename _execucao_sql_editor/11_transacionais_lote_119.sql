...
-- SALÁRIO: Stephane Soares Lima (Ref. dias trabalhad...
DO $$
DECLARE
...
-- Conciliação - PIX RECEBIDO - CP :00000000-MARIA SE...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :24313102-STEPHANE...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :60701190-LARISSA ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :18236120-MIKAELLY...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :18236120-JOELMA A...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- PASSWORD INTERATIVA BI E SOFTWARE - VIXEN > R$ 141...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX TRANSF  ELISANG09 09...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :90400888-KARINA A...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Almoço - COMPRA CARTAO - NO ESTABELECIMENTO LANCHO...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :18236120-ELIANE A...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :60701190-IEDA PIN...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- VISION PRIME - Parcela 2/8 > PIX: 34.130.608/0001-...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :60701190-LUCILENE...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'SERVIP SERVIÇOS P LTDA ME: Instalação das câmeras - Parcela 4/6 - 11) 9 5139-6200',
        'SERVIP SERVIÇOS P LTDA ME: Instalação das câmeras - Parcela 4/6 - 11) 9 5139-6200',
        '2025-10-18'::date,
        1040.0,
        1,
...
-- MARCELLY: Embalagens - Parcela 6/7 pix: 21.508.278...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'MARCELLY: Embalagens - Parcela 6/7 pix: 21.508.278/0001-44',
        'MARCELLY: Embalagens - Parcela 6/7 pix: 21.508.278/0001-44',
        '2023-11-17'::date,
        1085.0,
        1,
...
-- FAST COMPANY ARMAÇÕES E LENTES LTDA - Parcela 4/22...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'FAST COMPANY ARMAÇÕES E LENTES LTDA - Parcela 4/22 (compra da loja + rescisão Karina) - AR CONDICIONADO',
        'FAST COMPANY ARMAÇÕES E LENTES LTDA - Parcela 4/22 (compra da loja + rescisão Karina) - AR CONDICIONADO',
        '2024-03-14'::date,
        2200.0,
        1,
...
-- Confirmar o PIX!!!!  SALÁRIO: Geovana Silva Novaes...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :00360305-ALEXANDR...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Compras Nagumo - COMPRA CARTAO - NO ESTABELECIMENT...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :18236120-SONIA MA...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- RESCISÃO: Igor Nascimento Medeiros- Acordo 1/3 > P...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'RESCISÃO: Igor Nascimento Medeiros- Acordo 1/3 > PIX: igormeirells203@gmail.com (E-MAIL)',
        'RESCISÃO: Igor Nascimento Medeiros- Acordo 1/3 > PIX: igormeirells203@gmail.com (E-MAIL)',
        '2023-09-15'::date,
        1009.1,
        1,
...
-- ALUGUEL LOJA - SUZANO II (taxa boleto) > PIX: 39.7...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ALUGUEL LOJA - SUZANO II > PIX: 39.794.111/0001-52...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ALUGUEL LOJA - SUZANO II > PIX: 39.794.111/0001-52 (CNPJ)',
        'ALUGUEL LOJA - SUZANO II > PIX: 39.794.111/0001-52 (CNPJ)',
        '2023-10-02'::date,
        2300.0,
        1,
