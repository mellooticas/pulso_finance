...
-- CReDITO a VISTA - RECEBIVEIS DE VENDA - CIELO...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- PIX - RECEBIDO - 90400888 00031369181850 CARLOS ED...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'PIX - RECEBIDO - 90400888 00031369181850 CARLOS EDUARDO',
        'PIX - RECEBIDO - 90400888 00031369181850 CARLOS EDUARDO',
        '2020-12-21'::date,
        450.0,
        1,
...
-- PIX - RECEBIDO - 90400888 00019520621873 SIMONE AL...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'PIX - RECEBIDO - 90400888 00019520621873 SIMONE ALVES M',
        'PIX - RECEBIDO - 90400888 00019520621873 SIMONE ALVES M',
        '2020-12-21'::date,
        49.0,
        1,
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'TAR DOC/TED ELETRÔNICO    - COBRANcA REFERENTE 22/12/2020         ',
        'TAR DOC/TED ELETRÔNICO    - COBRANcA REFERENTE 22/12/2020         ',
        '2020-12-22'::date,
        10.45,
        1,
...
-- PAGAMENTO DE BOLETO - BOLETOBANCaRIO.COM TECNOLOGI...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'PAGAMENTO DE BOLETO - BOLETOBANCaRIO.COM TECNOLOGIA DE PAGAM',
        'PAGAMENTO DE BOLETO - BOLETOBANCaRIO.COM TECNOLOGIA DE PAGAM',
        '2020-12-22'::date,
        698.24,
        1,
