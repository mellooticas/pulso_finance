...
-- Conciliação - PIX RECEBIDO - CP :00360305-DAIANE D...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :60701190-RICHARD ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX - RECEBIDO26/05 11:13 0004119586...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :60746948-ODETE MA...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ÓTICAS KING - ref. 22/05-27/05/2023...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :17192451-ROSEMEIR...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX DEVOLUCAO RECEBIDA - CP :2289643...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :60701190-RODRIGO ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :08561701-ADENICIO...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :31872495-FERNANDA...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ICMS: Simples Nacional 08/2021 - Parcela 14/23 (Ju...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- CSLL: Simples Nacional 08/2021 - Parcela 14/23 (Ju...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :24313102-JULIANO ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- PIS: Simples Nacional 08/2021 - Parcela 14/23 (Jur...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- IRPJ: Simples Nacional 08/2021 - Parcela 14/23 (Ju...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'TAXA DE LICENÇA E FISCALIZAÇÃO DE FUCIONAMENTO (ALVARÁ DE FUNCIONAMENTO) - Parcela 3/4',
        'TAXA DE LICENÇA E FISCALIZAÇÃO DE FUCIONAMENTO (ALVARÁ DE FUNCIONAMENTO) - Parcela 3/4',
        '2025-10-18'::date,
        128.33,
        1,
...
-- INSS: Simples Nacional 08/2021 - Parcela 14/23 (Ju...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX - RECEBIDO01/06 15:10 1210924700...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'Conciliação - PIX - RECEBIDO01/06 15:10 12109247000120 CREDZ S A I',
        'Conciliação - PIX - RECEBIDO01/06 15:10 12109247000120 CREDZ S A I',
        '2023-06-01'::date,
        1090.8,
        1,
...
-- Conciliação - PIX RECEBIDO - CP :90400888-LUIS MAI...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :60746948-MARIO RO...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- MSL AGROPECUARIA DISTRIBUICAO: Confraternização - ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
