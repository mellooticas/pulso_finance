BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO: VISION PRIME - Parcela 22/49 > PIX: 47.392.457/0001-52 (CNPJ)',
        'ACORDO: VISION PRIME - Parcela 22/49 > PIX: 47.392.457/0001-52 (CNPJ)',
        '2025-10-18'::date,
        500.0,
        1,
...
-- Conciliação - PIX RECEBIDO - VANESSA DAS NEVES SIL...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - LAURO MARQUES DA SILV...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO > ALUGUEL LOJA - SUZANO I (ref. ao mês 11/2024) > parcela 1/5 > PIX: 02.131.820/0001-48 (CNPJ)',
        'ACORDO > ALUGUEL LOJA - SUZANO I (ref. ao mês 11/2024) > parcela 1/5 > PIX: 02.131.820/0001-48 (CNPJ)',
        '2025-01-07'::date,
        2821.0,
        1,
...
-- Conciliação - PIX RECEBIDO - LUCAS OLIVEIRA MOTA S...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- FÉRIAS: Jocicreide Macedo Barbosa Santos - Parcela...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'FÉRIAS: Jocicreide Macedo Barbosa Santos - Parcela 1/2 > PIX: (11) 9 8018-0836 (celular)',
        'FÉRIAS: Jocicreide Macedo Barbosa Santos - Parcela 1/2 > PIX: (11) 9 8018-0836 (celular)',
        '2025-02-07'::date,
        2120.33,
        1,
...
-- 1/3 DAS FÉRIAS: Jocicreide Macedo Barbosa Santos -...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        '1/3 DAS FÉRIAS: Jocicreide Macedo Barbosa Santos - Parcela 1/2 > PIX: (11) 9 8018-0836 (celular)',
        '1/3 DAS FÉRIAS: Jocicreide Macedo Barbosa Santos - Parcela 1/2 > PIX: (11) 9 8018-0836 (celular)',
        '2024-12-31'::date,
        1124.0,
        1,
...
-- VALE TRANSPORTE: Rosana Lucas dos Santos (ref. 03/...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- SALÁRIO: Beatriz Silva de Matos Araújo > (auxiliar...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- RESCISÃO: Eliana Savoia - Acordo 5/6 > PIX: 276.52...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'RESCISÃO: Eliana Savoia - Acordo 5/6 > PIX: 276.526.448-10 (CPF)',
        'RESCISÃO: Eliana Savoia - Acordo 5/6 > PIX: 276.526.448-10 (CPF)',
        '2025-01-10'::date,
        1000.0,
        1,
...
-- VALE TRANSPORTE: Felipe Roger Miranda > (diferença...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ACORDO: ACERTO FRANQUIA > Parcela 15/54 > PIX: 39....
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - ROBERTO RODRIGUES MOR...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - LUIZ GUSTAVO ROCHA GO...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - MARIA PAULA FARIAS ME...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - FABIO ALEXANDRE DE JE...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - VIVIAN CRISTINA DE ME...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - HENRY CHUKWUNONSO UME...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- FREELANCER: Thayna Kevilyn Corrêa Reis (ref. 04/01...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- COMPRA DE ARMAÇÕES: Allegre Comercial LTDA > PIX: ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- COMPRA DE ARMAÇÕES: Enming Li > PIX: 245.265.668-2...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ACORDO: ROB SOL INDUSTRIAL LTDA - Parcela 10/18 > ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO: ROB SOL INDUSTRIAL LTDA - Parcela 10/18 > PIX:',
        'ACORDO: ROB SOL INDUSTRIAL LTDA - Parcela 10/18 > PIX:',
        '2025-10-18'::date,
        660.0,
        1,
...
-- Conciliação - PIX RECEBIDO - JOSE CLAUDIO DOS SANT...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- VALE TRANSPORTE: Beatriz Silva de Matos Araújo (re...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- VALE TRANSPORTE: Pedro Henrique Armiliato dos Sant...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- GRAVAÇÃO DAS ARMAÇÕES E ESTOJOS: Magno dos Reis > ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- SALÁRIO: Nicolas Coutinho da Silva > PIX: analivia...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - LUANA CRISTINA MARTIN...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- VALE TRANSPORTE: Kathleen dos Santos Campos (difer...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
