...
-- Conciliação - PIX RECEBIDO - CP :00360305-GLAUCIA ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- 12/05/2023 - BRASLAB PRODUTOS OTICOS EIRELI...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :60746948-NEUSA PA...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX - RECEBIDO09/06 17:13 1210924700...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- 04/05/2023 - BRASLAB PRODUTOS OTICOS EIRELI > R$ 2...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        '04/05/2023 - BRASLAB PRODUTOS OTICOS EIRELI > R$ 2.618,85',
        '04/05/2023 - BRASLAB PRODUTOS OTICOS EIRELI > R$ 2.618,85',
        '2025-10-18'::date,
        2297.89,
        1,
...
-- ANUIDADE CLIENTE: Marcos Luiz Serafim - Parcela 2/...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- VALE TRANSPORTE: Eliana Savoia (ref. 05/06 - 13/06...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX - RECEBIDO12/06 20:53 0003665837...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :00000000-EDIVANIA...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'Conciliação - PIX RECEBIDO - CP :00000000-EDIVANIA T O FERREIRA',
        'Conciliação - PIX RECEBIDO - CP :00000000-EDIVANIA T O FERREIRA',
        '2023-06-12'::date,
        1000.0,
        1,
...
-- Conciliação - PIX RECEBIDO - CP :60746948-DANIEL J...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :90400888-BEATRIZ ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :90400888-ANA CARO...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :17184037-APARECID...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :90400888-FABIANO ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :09554480-ELAINE M...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :00000000-IDA STEI...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :00360305-JUDITE A...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :60746948-VERIDIAN...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- FAST COMPANY ARMAÇÕES E LENTES LTDA - Parcela 1/22...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'FAST COMPANY ARMAÇÕES E LENTES LTDA - Parcela 1/22 (compra da loja + rescisão Karina)',
        'FAST COMPANY ARMAÇÕES E LENTES LTDA - Parcela 1/22 (compra da loja + rescisão Karina)',
        '2023-08-09'::date,
        2200.0,
        1,
...
-- OPTOMETRISTA: Yasmin dos Santos  > R$ 00,00 > PIX:...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'OPTOMETRISTA: Yasmin dos Santos  > R$ 00,00 > PIX: 529.978.598-40 (CPF)',
        'OPTOMETRISTA: Yasmin dos Santos  > R$ 00,00 > PIX: 529.978.598-40 (CPF)',
        '2023-06-13'::date,
        4000.0,
        1,
...
-- MARCELLY: Embalagens - Parcela 3/7...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Estrela para cadeira giratória - Reginaldo Donizet...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Compra da loja - Óticas Taty Mello: Parcela 7/11...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'SERVIP SERVIÇOS P LTDA ME: Instalação das câmeras - Parcela 1/6',
        'SERVIP SERVIÇOS P LTDA ME: Instalação das câmeras - Parcela 1/6',
        '2023-06-13'::date,
        1040.0,
        1,
...
-- Conciliação - PIX - RECEBIDO14/06 14:04 1210924700...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- 08/05/2023 - BRASLAB PRODUTOS OTICOS EIRELI...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- BMP UTILIDADES DOMESTICAS S. A.: Pilha zinco AA e ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :60701190-GEOVANA ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
