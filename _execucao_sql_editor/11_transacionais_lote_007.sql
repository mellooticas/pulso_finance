...
-- PRO-LABORE JUNIOR - LORENA THIFANY PRIMO DINIS...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- PIX - RECEBIDO - 60746948 33186762000183 TITA NEGO...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'PIX - RECEBIDO - 60746948 33186762000183 TITA NEGOCIOS ',
        'PIX - RECEBIDO - 60746948 33186762000183 TITA NEGOCIOS ',
        '2020-12-18'::date,
        300.0,
        1,
