...
-- ACORDO: ACERTO FRANQUIA > Parcela 27/40 > PIX: 39....
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - JOZELI SILVA ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - JOSELMA ALVES DE SOUZ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - ISABELA DE OL...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- RESCISÃO: Érika de Oliveira Gomes - Acordo 7/8 > P...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - WELLINGTON FE...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'Conciliação - QR CODE PIX RECEBIDO - WELLINGTON FEITOSA DE ARAUJO',
        'Conciliação - QR CODE PIX RECEBIDO - WELLINGTON FEITOSA DE ARAUJO',
        '2024-08-31'::date,
        1130.0,
        1,
...
-- Conciliação - QR CODE PIX RECEBIDO - WILFRED FLERI...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - MARIA ILDA AR...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - ELIEL DUARTE ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - DEISE CRISTIN...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- HONORÁRIOS: Rodrigo da Silva Caineli > Parcela 2/2...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- FRANQUIA > PIX: (11) 9 8117-7178 (celular) - SUZAN...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- RESCISÃO: Eliana Savoia - Acordo 1/6 > PIX: 276.52...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'RESCISÃO: Eliana Savoia - Acordo 1/6 > PIX: 276.526.448-10 (CPF)',
        'RESCISÃO: Eliana Savoia - Acordo 1/6 > PIX: 276.526.448-10 (CPF)',
        '2024-09-02'::date,
        1000.0,
        1,
...
-- FRANQUIA > PIX: (11) 9 8117-7178 (celular) - moeda...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- FRANQUIA > PIX: (11) 9 8117-7178 (celular) - SÃO M...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Lançamento parcial - FRANQUIA > PIX: (11) 9 8117-7...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- FRANQUIA > PIX: 52.597.549/0001-09 (CNPJ) - SUZANO...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'FRANQUIA > PIX: 52.597.549/0001-09 (CNPJ) - SUZANO I',
        'FRANQUIA > PIX: 52.597.549/0001-09 (CNPJ) - SUZANO I',
        '2024-09-05'::date,
        2300.0,
        1,
...
-- Conciliação - QR CODE PIX RECEBIDO - CINTIA VANESS...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- INSTITUTO VISÃO:  2° Quinz. Agosto > PIX: 35.128.1...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - ELIZANDRA DIAS FERREI...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - EVIVALDO CLIMACO DA S...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - NATANAEL ANTUNES DOS ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ACORDO: ROB SOL INDUSTRIAL LTDA - Parcela 6/18 > P...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO: ROB SOL INDUSTRIAL LTDA - Parcela 6/18 > PIX:',
        'ACORDO: ROB SOL INDUSTRIAL LTDA - Parcela 6/18 > PIX:',
        '2025-10-18'::date,
        660.0,
        1,
...
-- Conciliação - QR CODE PIX RECEBIDO - ELAINE GOMES ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - JORGE ALVES D...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ACORDO: ACERTO FRANQUIA > Parcela 28/40 > PIX: 39....
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- GONÇALVES PADARIA E MERCEARIA: Pão francês > Carol...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- COMPRA DE ITENS PARA LOJA (decoração): Giovanna Me...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - SILENE LEITE ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
