...
-- RESCISÃO: Zaine de Lima Siqueira - Acordo 2/14 > P...
DO $$
DECLARE
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'RESCISÃO: Zaine de Lima Siqueira - Acordo 2/14 > PIX: 275.783.178-06 (CPF)',
        'RESCISÃO: Zaine de Lima Siqueira - Acordo 2/14 > PIX: 275.783.178-06 (CPF)',
        '2024-10-22'::date,
        1250.0,
        1,
...
-- OFTAMED CLINICA DE OLHOS EIRELI > PIX: 08.687.560/...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - JOSE LOURENCO...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - CARTÃO DE DÉBITO - MASUDA           ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - VERA LUCIA PIRES DA S...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - PEDRO DANILO BARBOSA ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - MARIA CLARA B...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ACORDO: ACERTO FRANQUIA > Parcela 5/54 > PIX: 39.4...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ACORDO: ACERTO FRANQUIA > Parcela 35/40 > PIX: 39....
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - TIAGO TEIXEIR...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - TAYNARA CRIST...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CLEUSA PINHEIRO DE O ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- FREELANCER: Esther Barbosa (ref. 19/10/2024) > PIX...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - RAQUEL FERNAN...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - RONIELIA DA S...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - DIVA DE OLIVE...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ACORDO: VISION PRIME - Parcela 18/49 > PIX: 47.392...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO: VISION PRIME - Parcela 18/49 > PIX: 47.392.457/0001-52 (CNPJ)',
        'ACORDO: VISION PRIME - Parcela 18/49 > PIX: 47.392.457/0001-52 (CNPJ)',
        '2025-10-18'::date,
        500.0,
        1,
...
-- Conciliação - PIX RECEBIDO - EDSON DE OLIVEIRA 054...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - SONAI MARIA D...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - CARTÃO DE DÉBITO - AUTO POSTO PARQUE...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - CARTÃO DE DÉBITO - RODOANEL         ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - CARTÃO DE DÉBITO - CONCESSIONARIA SP...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - CARTÃO DE DÉBITO - ECOPISTA FPAY    ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - RENATA LOPES ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - ADRIANO SANTIAGO SOAR...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- RESCISÃO: Eliana Savoia - Acordo 3/6 > PIX: 276.52...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'RESCISÃO: Eliana Savoia - Acordo 3/6 > PIX: 276.526.448-10 (CPF)',
        'RESCISÃO: Eliana Savoia - Acordo 3/6 > PIX: 276.526.448-10 (CPF)',
        '2024-10-31'::date,
        1000.0,
        1,
...
-- Conciliação - QR CODE PIX RECEBIDO - QUEREEN SANTO...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - SIMONE RAMOS BRITTO S...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - CARTÃO DE DÉBITO - ESTACIONAMENTOS E...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
