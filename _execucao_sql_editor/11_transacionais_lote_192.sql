BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO > ALUGUEL MAUÁ - Loja (ref. 04/2025) > parcela 18/18 > PIX: 096.395.938-77 (CPF - Juarez)',
        'ACORDO > ALUGUEL MAUÁ - Loja (ref. 04/2025) > parcela 18/18 > PIX: 096.395.938-77 (CPF - Juarez)',
        '2025-10-18'::date,
        173.21,
        1,
...
-- Conciliação - PIX RECEBIDO - MARIA DAS VITORIAS NE...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - VICTOR ANTONIO OLIVEI...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO > ALUGUEL & FRANQUIA > Rio Pequeno - Loja (ref. dez/2024 e jan/2025) > parcela 128/134 > PIX: 52.597.549/0001-09 (CNPJ)',
        'ACORDO > ALUGUEL & FRANQUIA > Rio Pequeno - Loja (ref. dez/2024 e jan/2025) > parcela 128/134 > PIX: 52.597.549/0001-09 (CNPJ)',
        '2025-10-18'::date,
        100.0,
        1,
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO > ALUGUEL MAUÁ - Clínica (ref. 03/2025 e 04/2025) > parcela 18/18 > PIX: 096.395.938-77 (CPF - Juarez)',
        'ACORDO > ALUGUEL MAUÁ - Clínica (ref. 03/2025 e 04/2025) > parcela 18/18 > PIX: 096.395.938-77 (CPF - Juarez)',
        '2025-10-18'::date,
        346.42,
        1,
...
-- Conciliação - PIX RECEBIDO - KAIO CEZAR DA SILVA S...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - ANA CAROLINY DE ALMEI...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO > ALUGUEL & FRANQUIA > Rio Pequeno - Loja (ref. dez/2024 e jan/2025) > parcela 130/134 > PIX: 52.597.549/0001-09 (CNPJ)',
        'ACORDO > ALUGUEL & FRANQUIA > Rio Pequeno - Loja (ref. dez/2024 e jan/2025) > parcela 130/134 > PIX: 52.597.549/0001-09 (CNPJ)',
        '2025-10-18'::date,
        100.0,
        1,
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO > ALUGUEL & FRANQUIA > Rio Pequeno - Loja (ref. dez/2024 e jan/2025) > parcela 131/134 > PIX: 52.597.549/0001-09 (CNPJ)',
        'ACORDO > ALUGUEL & FRANQUIA > Rio Pequeno - Loja (ref. dez/2024 e jan/2025) > parcela 131/134 > PIX: 52.597.549/0001-09 (CNPJ)',
        '2025-10-18'::date,
        100.0,
        1,
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO > ALUGUEL & FRANQUIA > Rio Pequeno - Loja (ref. dez/2024 e jan/2025) > parcela 132/134 > PIX: 52.597.549/0001-09 (CNPJ)',
        'ACORDO > ALUGUEL & FRANQUIA > Rio Pequeno - Loja (ref. dez/2024 e jan/2025) > parcela 132/134 > PIX: 52.597.549/0001-09 (CNPJ)',
        '2025-10-18'::date,
        100.0,
        1,
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO > ALUGUEL & FRANQUIA > Rio Pequeno - Loja (ref. dez/2024 e jan/2025) > parcela 133/134 > PIX: 52.597.549/0001-09 (CNPJ)',
        'ACORDO > ALUGUEL & FRANQUIA > Rio Pequeno - Loja (ref. dez/2024 e jan/2025) > parcela 133/134 > PIX: 52.597.549/0001-09 (CNPJ)',
        '2025-10-18'::date,
        100.0,
        1,
...
-- ACORDO: ROB SOL INDUSTRIAL LTDA - Parcela 15/18 > ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO: ROB SOL INDUSTRIAL LTDA - Parcela 15/18 > PIX:',
        'ACORDO: ROB SOL INDUSTRIAL LTDA - Parcela 15/18 > PIX:',
        '2025-10-18'::date,
        660.0,
        1,
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO > ALUGUEL LOJA - PERUS (finalização do contrato) > parcela 8/8 > PIX: santos3imoveis@gmail.com (e-mail)',
        'ACORDO > ALUGUEL LOJA - PERUS (finalização do contrato) > parcela 8/8 > PIX: santos3imoveis@gmail.com (e-mail)',
        '2025-10-18'::date,
        500.0,
        1,
...
-- RESCISÃO: Felipe Roger Miranda > PIX: (11) 9 5805-...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- SALÁRIO: Ariani Dias Fernandes Líbano (ref. 02/06 ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- RESCISÃO: Camila Faccin Vieira - Parcela 1/2 > PIX...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO > ALUGUEL & FRANQUIA > Rio Pequeno - Loja (ref. dez/2024 e jan/2025) > parcela 134/134 > PIX: 52.597.549/0001-09 (CNPJ)',
        'ACORDO > ALUGUEL & FRANQUIA > Rio Pequeno - Loja (ref. dez/2024 e jan/2025) > parcela 134/134 > PIX: 52.597.549/0001-09 (CNPJ)',
        '2025-10-18'::date,
        150.0,
        1,
...
-- SALÁRIO: Thiago Vinicius Andrade SIqueira (ref. 14...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - FABIANA MARCIA DA SIL...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ACORDO: SYGMA LABORATORIO OPTICO LTDA > Parcela 15...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ACORDO: Bruna Giovanna Cardoso > Parcela 12/12 > P...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO: Bruna Giovanna Cardoso > Parcela 12/12 > PIX: 436.984.648-02 (CPF)',
        'ACORDO: Bruna Giovanna Cardoso > Parcela 12/12 > PIX: 436.984.648-02 (CPF)',
        '2025-10-18'::date,
        844.16,
        1,
...
-- FAST COMPANY ARMAÇÕES E LENTES LTDA - Parcela 8/10...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'FAST COMPANY ARMAÇÕES E LENTES LTDA - Parcela 8/10 > PIX: fastnegocios@outlook.com (e-mail)',
        'FAST COMPANY ARMAÇÕES E LENTES LTDA - Parcela 8/10 > PIX: fastnegocios@outlook.com (e-mail)',
        '2025-10-18'::date,
        1000.0,
        1,
...
-- COMPRA E GRAVAÇÃO DE AMOSTRAS: Magno dos Reis > PI...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - MARIA MESSIAS B DOS S...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ESTORNO CLIENTE: Cynhtia Souza Leite dos Santos > ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ESTORNO CLIENTE: Cynhtia Souza Leite dos Santos > Reembolso: 10944, 10945 e 10946 (AUT: 690326 I Dígitos do cartão: 3258)',
        'ESTORNO CLIENTE: Cynhtia Souza Leite dos Santos > Reembolso: 10944, 10945 e 10946 (AUT: 690326 I Dígitos do cartão: 3258)',
        '2025-06-12'::date,
        2711.8,
        1,
...
-- ACORDO: VISION PRIME - Parcela 33/49 > PIX: 47.392...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO: VISION PRIME - Parcela 33/49 > PIX: 47.392.457/0001-52 (CNPJ)',
        'ACORDO: VISION PRIME - Parcela 33/49 > PIX: 47.392.457/0001-52 (CNPJ)',
        '2025-10-18'::date,
        500.0,
        1,
...
-- SUPERMERCADO SANTA FÉ: Margarina > Kayllaine Perei...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
