...
-- Conciliação - PIX RECEBIDO - EZEQUIEL PEREIRA SOLE...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- CONSULTA: Luana Cristina Martins Campos > PIX: lua...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX ENVIADO - JOYCE NAILÊ DA SILVA S...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - MARIA DORES SILVA COS...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- DEVOLUÇÃO PIX RECEBIDA - Pix errado - Maria das Do...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- INSTITUTO VISÃO: 2° Quinz. Março > PIX: 35.128.190...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - FRANCISCA MARGARETH G...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- VALE TRANSPORTE: Jenny Oliveira Santos Ramos (auxi...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- COMPRA DE ÁGUA - Everton Cardoso > PIX: 365.967.58...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- RESCISÃO: Cleberson Ribeiro de Jesus - Acordo 6/6 ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'FUNDO DE GARANTIA DO TEMPO DE SERVIÇO (competência 03/2024)',
        'FUNDO DE GARANTIA DO TEMPO DE SERVIÇO (competência 03/2024)',
        '2025-10-18'::date,
        755.31,
        1,
...
-- Conciliação - PIX RECEBIDO - MARCELO ROBERTO DO NA...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - GILMAR JOSE D...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - GISELE MOURA ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'CONTRIBUIÇÃO PREVIDENCIÁRIA DESCONTA SEGURADO-EMPREGADO/INDIVIDUAIS',
        'CONTRIBUIÇÃO PREVIDENCIÁRIA DESCONTA SEGURADO-EMPREGADO/INDIVIDUAIS',
        '2025-10-18'::date,
        348.29,
        1,
...
-- Conciliação - PIX RECEBIDO - FLAVIA BARBOSA DA SIL...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - HERMES ADAO MACEDO DA...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - SANDRA CASAGR...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ACORDO: ACERTO FRANQUIA > Parcela 8/40 > PIX: 39.4...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - ARTHUR PORTELA PEREIR...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - ELITA SOARES DA SILVA...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ALUGUEL CLÍNICA - MAUÁ (diferença, ref. 03/2024)...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - FERNANDO JOAO...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ALUGUEL LOJA - MAUÁ (IPTU) - ref. 03/2024 (diferen...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ALUGUEL LOJA - MAUÁ (IPTU) - ref. 03/2024 (diferença)',
        'ALUGUEL LOJA - MAUÁ (IPTU) - ref. 03/2024 (diferença)',
        '2025-10-18'::date,
        3.5,
        1,
...
-- OPTOMETRISTA: Eduardo 1° Quinz. Abril > PIX: 226.0...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ALUGUEL LOJA - MAUÁ (diferença, ref. 03/2024)...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- INSTITUTO VISÃO: 1° Quinz. Abril > PIX: 35.128.190...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CRISTIANE BARROS DOS ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- COFINS: Simples Nacional 03/2024...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- semana trabalhados freelance - PIX ENVIADO - CLEBE...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ENEL 0049320513 - LOJA RIO PEQUENO PIX) Roberto - ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ALUGUEL LOJA - RIO PEQUENO (PIX) Roberto - 52.597....
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ALUGUEL LOJA - RIO PEQUENO (PIX) Roberto - 52.597.549/0001-09 (cnpj)',
        'ALUGUEL LOJA - RIO PEQUENO (PIX) Roberto - 52.597.549/0001-09 (cnpj)',
        '2024-04-22'::date,
        2875.0,
        1,
...
-- Conciliação - PIX RECEBIDO - SILVANI FATIMA B MESQ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- SABESP - LOJA RIO PEQUENO RGI 0874132747 > PIX: 52...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
