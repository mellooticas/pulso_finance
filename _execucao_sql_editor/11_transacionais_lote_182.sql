...
-- ÓTICAS REINO DOS ÓCULOS: Montagem > PIX: (11) 9 92...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ACORDO: Bruna Giovanna Cardoso > Parcela 8/12 > PI...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO: Bruna Giovanna Cardoso > Parcela 8/12 > PIX: 436.984.648-02 (CPF)',
        'ACORDO: Bruna Giovanna Cardoso > Parcela 8/12 > PIX: 436.984.648-02 (CPF)',
        '2025-10-18'::date,
        844.17,
        1,
...
-- Conciliação - PIX RECEBIDO - MICHELE RODRIGUES SAI...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - ERICA DA SILVA BARBOS...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- SALÁRIO: Cleberson Ribeiro de Jesus (ref. 09 dias ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- FAST COMPANY ARMAÇÕES E LENTES LTDA - Parcela 4/10...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'FAST COMPANY ARMAÇÕES E LENTES LTDA - Parcela 4/10 > PIX: fastnegocios@outlook.com (e-mail)',
        'FAST COMPANY ARMAÇÕES E LENTES LTDA - Parcela 4/10 > PIX: fastnegocios@outlook.com (e-mail)',
        '2025-10-18'::date,
        1000.0,
        1,
...
-- Conciliação - PIX RECEBIDO - PALOMA DUARTE ALVES D...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - JÚLIO CESAR BARBOSA R...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ACORDO: VISION PRIME - Parcela 25/49 > PIX: 47.392...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO: VISION PRIME - Parcela 25/49 > PIX: 47.392.457/0001-52 (CNPJ)',
        'ACORDO: VISION PRIME - Parcela 25/49 > PIX: 47.392.457/0001-52 (CNPJ)',
        '2025-10-18'::date,
        500.0,
        1,
...
-- SÃO PAULO ACESSÓRIOS ÓPTICOS: Conjunto de chaves 1...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - IGREJA APOSTÓLICA UNÇ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - ADRIANA SILVA MARTINS...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - VALÉRIA MARTINS DE OL...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - PETER DA COSTA ANDRAD...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CAMILA NAJA DE ALMEID...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'COLÉGIO INTEGRADO LUMBINI: Extras - Nicolly Mello de Camargo - Parcela 2/12 > PIX: 00.875.904/0001-60 (CNPJ)',
        'COLÉGIO INTEGRADO LUMBINI: Extras - Nicolly Mello de Camargo - Parcela 2/12 > PIX: 00.875.904/0001-60 (CNPJ)',
        '2025-10-18'::date,
        352.08,
        1,
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'COLÉGIO INTEGRADO LUMBINI: Mensalidade + Rematrícula - Nicolly Mello de Camargo - Parcela 2/12 > PIX: 00.875.904/0001-60 (CNPJ)',
        'COLÉGIO INTEGRADO LUMBINI: Mensalidade + Rematrícula - Nicolly Mello de Camargo - Parcela 2/12 > PIX: 00.875.904/0001-60 (CNPJ)',
        '2025-10-18'::date,
        940.0,
        1,
