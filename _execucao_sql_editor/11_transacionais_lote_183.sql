...
-- SÃO PAULO ACESSÓRIOS ÓPTICOS: Cordão de tecido e P...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - GABRIEL AUGUSTINHO DA...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ARMARINHOS FERNANDO LTDA: Folha de sulfite > PIX: ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- RESCISÃO: Mike Rodrigues Gomes - Acordo 5/7 > PIX:...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'FUNDO DE GARANTIA DO TEMPO DE SERVIÇO (competência 01/2025)',
        'FUNDO DE GARANTIA DO TEMPO DE SERVIÇO (competência 01/2025)',
        '2025-10-18'::date,
        418.87,
        1,
...
-- RESCISÃO: Zaine de Lima Siqueira - Acordo 6/14 > P...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'RESCISÃO: Zaine de Lima Siqueira - Acordo 6/14 > PIX: 275.783.178-06 (CPF)',
        'RESCISÃO: Zaine de Lima Siqueira - Acordo 6/14 > PIX: 275.783.178-06 (CPF)',
        '2025-10-18'::date,
        1250.0,
        1,
...
-- Conciliação - PIX RECEBIDO - ROBSON SOUZA DOS SANT...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - MICHELLE ABDALLA PRAD...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ALUGUEL ESCRITÓRIO - SUZANO > PIX: 02.131.820/0001-48 (CNPJ) - (ITAÚ - Junior)',
        'ALUGUEL ESCRITÓRIO - SUZANO > PIX: 02.131.820/0001-48 (CNPJ) - (ITAÚ - Junior)',
        '2025-02-25'::date,
        2455.0,
        1,
...
-- ADEGA DO BAIANO: Pó de café > Kayllaine Pereira Al...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- RESCISÃO: Ariani Dias Fernandes Líbano - Acordo 5/...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
