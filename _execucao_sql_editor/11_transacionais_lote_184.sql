...
-- Conciliação - PIX RECEBIDO - GILBERTO DOS SANTOS O...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO > ALUGUEL LOJA - PERUS (finalização do contrato) > parcela 1/8 > PIX: santos3imoveis@gmail.com (e-mail)',
        'ACORDO > ALUGUEL LOJA - PERUS (finalização do contrato) > parcela 1/8 > PIX: santos3imoveis@gmail.com (e-mail)',
        '2025-02-27'::date,
        1000.0,
        1,
...
-- ACORDO: VISION PRIME - Parcela 26/49 > PIX: 47.392...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO: VISION PRIME - Parcela 26/49 > PIX: 47.392.457/0001-52 (CNPJ)',
        'ACORDO: VISION PRIME - Parcela 26/49 > PIX: 47.392.457/0001-52 (CNPJ)',
        '2025-10-18'::date,
        500.0,
        1,
...
-- Conciliação - PIX RECEBIDO - RAUL FELIPE ALVAREZ M...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO > ALUGUEL LOJA - SUZANO I (ref. ao mês 11/2024) > parcela 3/5 > PIX: 02.131.820/0001-48 (CNPJ)',
        'ACORDO > ALUGUEL LOJA - SUZANO I (ref. ao mês 11/2024) > parcela 3/5 > PIX: 02.131.820/0001-48 (CNPJ)',
        '2025-02-28'::date,
        2821.0,
        1,
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO > ALUGUEL MAUÁ- Loja (ref. 11/2024, 12/2024 e 01/2025) > parcela 1/9 > BANCO: Bradesco | Agência: 2229 | Conta Corrente: 1433-8',
        'ACORDO > ALUGUEL MAUÁ- Loja (ref. 11/2024, 12/2024 e 01/2025) > parcela 1/9 > BANCO: Bradesco | Agência: 2229 | Conta Corrente: 1433-8',
        '2025-02-28'::date,
        1105.9,
        1,
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        '2° ACORDO: COLÉGIO INTEGRADO LUMBINI: Nicolly Mello de Camargo - Parcela 2/49 > PIX: 00.875.904/0001-60 (CNPJ)',
        '2° ACORDO: COLÉGIO INTEGRADO LUMBINI: Nicolly Mello de Camargo - Parcela 2/49 > PIX: 00.875.904/0001-60 (CNPJ)',
        '2025-10-18'::date,
        81.63,
        1,
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO > ALUGUEL MAUÁ- Clínica (ref. 11/2024, 12/2024 e 01/2025) > parcela 1/9 (PIX Juarez)',
        'ACORDO > ALUGUEL MAUÁ- Clínica (ref. 11/2024, 12/2024 e 01/2025) > parcela 1/9 (PIX Juarez)',
        '2025-04-05'::date,
        1105.9,
        1,
...
-- ACORDO: SYGMA LABORATORIO OPTICO LTDA > Parcela 1/...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- FREELANCER: Ariani Dias Fernandes Líbano (ref. 01/...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ESTORNO CLIENTE (troco) - Nair Aparecida de Souza ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ADIANTAMENTO SALARIAL: Maria Elizabeth Pereira do ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ACORDO: ROB SOL INDUSTRIAL LTDA - Parcela 12/18 > ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO: ROB SOL INDUSTRIAL LTDA - Parcela 12/18 > PIX:',
        'ACORDO: ROB SOL INDUSTRIAL LTDA - Parcela 12/18 > PIX:',
        '2025-10-18'::date,
        660.0,
        1,
...
-- ACORDO: Bruna Giovanna Cardoso > Parcela 9/12 > PI...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO: Bruna Giovanna Cardoso > Parcela 9/12 > PIX: 436.984.648-02 (CPF)',
        'ACORDO: Bruna Giovanna Cardoso > Parcela 9/12 > PIX: 436.984.648-02 (CPF)',
        '2025-10-18'::date,
        844.16,
        1,
...
-- SALÁRIO: Carolina Beatriz dos Santos Serafim (auxi...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - SILVANIA PEREIRA ALVE...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ASSAÍ ATACADISTA: Itens para loja > PIX: 4541adc2-...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - LEONARDO DE LIMA MARQ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
