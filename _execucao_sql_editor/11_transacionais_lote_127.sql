...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO > ALUGUEL MAUÁ - Clínica (ref. jul., ago. & set./2023) > parcela 2/2 > BANCO: Bradesco | Agência: 2229 | Conta Corrente: 1433-8',
        'ACORDO > ALUGUEL MAUÁ - Clínica (ref. jul., ago. & set./2023) > parcela 2/2 > BANCO: Bradesco | Agência: 2229 | Conta Corrente: 1433-8',
        '2023-11-16'::date,
        1201.85,
        1,
...
-- Conciliação - PIX RECEBIDO - CP :10573521-RICHARD ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO > ALUGUEL MAUÁ- Loja (ref. jul., ago. & set./2023) > parcela 2/2 > BANCO: Bradesco | Agência: 2229 | Conta Corrente: 1433-8',
        'ACORDO > ALUGUEL MAUÁ- Loja (ref. jul., ago. & set./2023) > parcela 2/2 > BANCO: Bradesco | Agência: 2229 | Conta Corrente: 1433-8',
        '2023-11-16'::date,
        1201.85,
        1,
...
-- Conciliação - PIX RECEBIDO - CP :22896431-ESTER KA...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ALUGUEL LOJA - SUZANO II (SUZANO I)...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ALUGUEL LOJA - SUZANO II (taxa boleto) - (moedas d...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ALUGUEL LOJA - SUZANO II (Juros/Multas) - (SUZANO ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ACORDO 2/8: SABESP - ESCRITÓRIO SUZANO RGI 0685311...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ALUGUEL LOJA - SUZANO II (taxa boleto) - (SUZANO I...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- GRAXA NAS PORTAS - William > PIX: (11) 9 7176-5828...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Compra de Armações receitoário - 24 armações - val...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- SALÁRIO: Larissa Dias Fernandes Cardozo (ref. dife...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Compra da loja - Óticas Taty Mello: Parcela 3/6 (R...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'Compra da loja - Óticas Taty Mello: Parcela 3/6 (Renegociação)',
        'Compra da loja - Óticas Taty Mello: Parcela 3/6 (Renegociação)',
        '2025-10-18'::date,
        2472.0,
        1,
...
-- RENEGOCIAÇÃO: FOCO OPTOMETRIA - Parcela 3/9 > PIX:...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'RENEGOCIAÇÃO: FOCO OPTOMETRIA - Parcela 3/9 > PIX: 46.081.461/0001-37 (CNPJ)',
        'RENEGOCIAÇÃO: FOCO OPTOMETRIA - Parcela 3/9 > PIX: 46.081.461/0001-37 (CNPJ)',
        '2023-12-18'::date,
        1500.0,
        1,
...
-- FAST COMPANY ARMAÇÕES E LENTES LTDA - Parcela 3/18...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'FAST COMPANY ARMAÇÕES E LENTES LTDA - Parcela 3/18 > PIX: fastnegocios@outlook.com (e-mail) - Tablet 1',
        'FAST COMPANY ARMAÇÕES E LENTES LTDA - Parcela 3/18 > PIX: fastnegocios@outlook.com (e-mail) - Tablet 1',
        '2024-03-14'::date,
        1060.0,
        1,
...
-- Conciliação - PIX RECEBIDO - CP :60701190-FRANCISC...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :18236120-PATRICK ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- OPTOMETRISTA: Eduardo 1° Quinz. Novembro > PIX: 22...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- SALÁRIO: Marcela da Silva Lemes (divulgadora, ref....
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- COFINS: Simples Nacional 10/2023...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Compra de Armações receitoário - 7 armações - valo...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :33264668-NICOLAS ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CP :18236120-ANA ALIC...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- INSTITUTO VISÃO: 1° Quinz. Novembro > PIX: 35.128....
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
