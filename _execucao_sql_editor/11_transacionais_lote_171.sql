...
-- Conciliação - PIX RECEBIDO - MARIA CLARA BARROS DE...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ACORDO: ACERTO FRANQUIA > Parcela 36/40 > PIX: 39....
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ACORDO: ACERTO FRANQUIA > Parcela 6/54 > PIX: 39.4...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- INSTITUTO VISÃO:  2° Quinz. Outubro > PIX: 35.128....
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - ELIZÂNGELA AL...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- LUCIMAR TOLEDO LIMA VAZ - EPP: Pão francês > Thiag...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - RUIVALDO CAET...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ACORDO: ROB SOL INDUSTRIAL LTDA - Parcela 8/18 > P...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO: ROB SOL INDUSTRIAL LTDA - Parcela 8/18 > PIX:',
        'ACORDO: ROB SOL INDUSTRIAL LTDA - Parcela 8/18 > PIX:',
        '2025-10-18'::date,
        660.0,
        1,
...
-- Conciliação - PIX RECEBIDO - ROSILEIDE SOUZA DA SI...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - NUTRI CARNES COMERCIO...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- HONORÁRIOS: Bruna Giovanna Cardoso > Parcela 7/8 >...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'HONORÁRIOS: Bruna Giovanna Cardoso > Parcela 7/8 > PIX: 436.984.648-02 (CPF)',
        'HONORÁRIOS: Bruna Giovanna Cardoso > Parcela 7/8 > PIX: 436.984.648-02 (CPF)',
        '2025-10-18'::date,
        500.0,
        1,
...
-- Conciliação - QR CODE PIX RECEBIDO - ROBERTO MORAI...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'SALÁRIO: Thiago Yuri da Silva Yuki > PIX: yukicomercial@gmail.com (e-mail) ~ RIO PEQUENO',
        'SALÁRIO: Thiago Yuri da Silva Yuki > PIX: yukicomercial@gmail.com (e-mail) ~ RIO PEQUENO',
        '2024-11-12'::date,
        1087.0,
        1,
...
-- Conciliação - QR CODE PIX RECEBIDO - CIBELE DE PAU...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - MARIA NEUZA SANTOS DA...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
