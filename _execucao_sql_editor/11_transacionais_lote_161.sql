...
-- ACORDO > ALUGUEL MAUÁ- Loja (ref. ) > parcela 7/10...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO > ALUGUEL MAUÁ- Loja (ref. ) > parcela 7/10 > BANCO: Bradesco | Agência: 2229 | Conta Corrente: 1433-8',
        'ACORDO > ALUGUEL MAUÁ- Loja (ref. ) > parcela 7/10 > BANCO: Bradesco | Agência: 2229 | Conta Corrente: 1433-8',
        '2024-08-16'::date,
        1093.7,
        1,
...
-- ACORDO: ACERTO FRANQUIA > Parcela 25/40 > PIX: 39....
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - HELEN LUCINDA...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - VERÔNICA DA S...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO > ALUGUEL MAUÁ - Clínica (ref. ) > parcela 7/10 > BANCO: Bradesco | Agência: 2229 | Conta Corrente: 1433-8',
        'ACORDO > ALUGUEL MAUÁ - Clínica (ref. ) > parcela 7/10 > BANCO: Bradesco | Agência: 2229 | Conta Corrente: 1433-8',
        '2024-08-16'::date,
        1093.7,
        1,
...
-- Conciliação - QR CODE PIX RECEBIDO - MIGUEL PEZZUO...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - CARINA CORREA...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - ERIVALDO PORF...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- OPTOMETRISTA: Tales (ref. 18/08/2024 - campanha) >...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX ENVIADO - ROSANGELA APARECIDA DE...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'FUNDO DE GARANTIA DO TEMPO DE SERVIÇO (competência 07/2024)',
        'FUNDO DE GARANTIA DO TEMPO DE SERVIÇO (competência 07/2024)',
        '2025-10-18'::date,
        382.84,
        1,
...
-- COFINS: Simples Nacional 07/2024...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - QR CODE PIX RECEBIDO - THAINARA DE J...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CESARIO DE OLIVEIRA S...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
