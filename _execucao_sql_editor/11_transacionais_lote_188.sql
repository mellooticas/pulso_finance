...
-- ACORDO: SYGMA LABORATORIO OPTICO LTDA > Parcela 7/...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- ACORDO: VISION PRIME - Parcela 29/49 > PIX: 47.392...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO: VISION PRIME - Parcela 29/49 > PIX: 47.392.457/0001-52 (CNPJ)',
        'ACORDO: VISION PRIME - Parcela 29/49 > PIX: 47.392.457/0001-52 (CNPJ)',
        '2025-10-18'::date,
        500.0,
        1,
...
-- FÉRIAS: Aline Cristina Moreira da Cunha > PIX: 537...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- TAXA DE EXPEDIENTE 2025 - Prefeitura Municipal de ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- 1/3 DAS FÉRIAS: Aline Cristina Moreira da Cunha > ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- MONTAGEM: Óticas Vênice (ref. OS 4848) > PIX: 42.0...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- VALE TRANSPORTE: Camila Faccin Vieira (ref. 15/04 ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CLARA DE SOUZA NOGUEI...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - SILVIA MARIA N DAMASC...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'COLÉGIO INTEGRADO LUMBINI: Mensalidade + Rematrícula - Nicolly Mello de Camargo - Parcela 4/12 > PIX: 00.875.904/0001-60 (CNPJ)',
        'COLÉGIO INTEGRADO LUMBINI: Mensalidade + Rematrícula - Nicolly Mello de Camargo - Parcela 4/12 > PIX: 00.875.904/0001-60 (CNPJ)',
        '2025-10-18'::date,
        940.0,
        1,
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'COLÉGIO INTEGRADO LUMBINI: Extras - Nicolly Mello de Camargo - Parcela 4/12 > PIX: 00.875.904/0001-60 (CNPJ)',
        'COLÉGIO INTEGRADO LUMBINI: Extras - Nicolly Mello de Camargo - Parcela 4/12 > PIX: 00.875.904/0001-60 (CNPJ)',
        '2025-10-18'::date,
        352.08,
        1,
...
-- Conciliação - PIX RECEBIDO - SELMA BORGES DOS SANT...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO: LIVRO ÓPTICO: Vivian Maria Ramos - Parcela 7/15 > PIX: (11) 9 6443-0482 (celular)',
        'ACORDO: LIVRO ÓPTICO: Vivian Maria Ramos - Parcela 7/15 > PIX: (11) 9 6443-0482 (celular)',
        '2025-10-18'::date,
        117.5,
        1,
...
-- CONTRIBUIÇÃO PREVIDENCIÁRIA EMPRESA/EMPREGADOR - T...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'CONTRIBUIÇÃO PREVIDENCIÁRIA EMPRESA/EMPREGADOR - TM COMERCIO VAREJISTA DE OTICA LTDA',
        'CONTRIBUIÇÃO PREVIDENCIÁRIA EMPRESA/EMPREGADOR - TM COMERCIO VAREJISTA DE OTICA LTDA',
        '2025-10-18'::date,
        461.01,
        1,
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ALUGUEL LOJA - SUZANO I (multa por atraso do aluguel, ref. 03/2024) > PIX: 02.131.820/0001-48 (CNPJ) > 17/03/2025',
        'ALUGUEL LOJA - SUZANO I (multa por atraso do aluguel, ref. 03/2024) > PIX: 02.131.820/0001-48 (CNPJ) > 17/03/2025',
        '2025-06-03'::date,
        1229.38,
        1,
...
-- IRRF - RENDIMENTO DO TRABALHO ASSALARIADO - TM COM...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'IRRF - RENDIMENTO DO TRABALHO ASSALARIADO - TM COMERCIO VAREJISTA DE OTICA LTDA',
        'IRRF - RENDIMENTO DO TRABALHO ASSALARIADO - TM COMERCIO VAREJISTA DE OTICA LTDA',
        '2025-10-18'::date,
        194.88,
        1,
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'CONTRIBUIÇÃO PREV RISCO AMBIENTAL/APOSENT ESPECIAL - TM COMERCIO VAREJISTA DE OTICA LTDA',
        'CONTRIBUIÇÃO PREV RISCO AMBIENTAL/APOSENT ESPECIAL - TM COMERCIO VAREJISTA DE OTICA LTDA',
        '2025-10-18'::date,
        21.91,
        1,
...
-- CP TERCEIROS - SENAC  - TMC COMERCIO VAREJISTA DE ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'CP TERCEIROS - SENAC  - TMC COMERCIO VAREJISTA DE OTICA LTDA',
        'CP TERCEIROS - SENAC  - TMC COMERCIO VAREJISTA DE OTICA LTDA',
        '2025-10-18'::date,
        0.77,
        1,
...
-- CP TERCEIROS - SESC - TM COMERCIO VAREJISTA DE OTI...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'CP TERCEIROS - SESC - TM COMERCIO VAREJISTA DE OTICA LTDA',
        'CP TERCEIROS - SESC - TM COMERCIO VAREJISTA DE OTICA LTDA',
        '2025-10-18'::date,
        32.87,
        1,
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'CONTRIBUIÇÃO PREVIDENCIÁRIA EMPRESA/EMPREGADOR  - TMC COMERCIO VAREJISTA DE OTICA LTDA',
        'CONTRIBUIÇÃO PREVIDENCIÁRIA EMPRESA/EMPREGADOR  - TMC COMERCIO VAREJISTA DE OTICA LTDA',
        '2025-10-18'::date,
        15.49,
        1,
...
-- CP TERCEIROS - SALÁRIO EDUCAÇÃO - TM COMERCIO VARE...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'CP TERCEIROS - SALÁRIO EDUCAÇÃO - TM COMERCIO VAREJISTA DE OTICA LTDA',
        'CP TERCEIROS - SALÁRIO EDUCAÇÃO - TM COMERCIO VAREJISTA DE OTICA LTDA',
        '2025-10-18'::date,
        54.79,
        1,
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'CONTRIBUIÇÃO PREVIDENCIÁRIA DESCONTA SEGURADO-EMPREGADO/AVULSO - TMO COMERCIO VAREJISTA DE OTICA LTDA',
        'CONTRIBUIÇÃO PREVIDENCIÁRIA DESCONTA SEGURADO-EMPREGADO/AVULSO - TMO COMERCIO VAREJISTA DE OTICA LTDA',
        '2025-10-18'::date,
        373.69,
        1,
...
-- CP TERCEIROS - SESC  - TMC COMERCIO VAREJISTA DE O...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'CP TERCEIROS - SESC  - TMC COMERCIO VAREJISTA DE OTICA LTDA',
        'CP TERCEIROS - SESC  - TMC COMERCIO VAREJISTA DE OTICA LTDA',
        '2025-10-18'::date,
        1.16,
        1,
...
-- CP TERCEIROS - SENAC - TM COMERCIO VAREJISTA DE OT...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'CP TERCEIROS - SENAC - TM COMERCIO VAREJISTA DE OTICA LTDA',
        'CP TERCEIROS - SENAC - TM COMERCIO VAREJISTA DE OTICA LTDA',
        '2025-10-18'::date,
        21.91,
        1,
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'CONTRIBUIÇÃO PREVIDENCIÁRIA DESCONTA SEGURADO-EMPREGADO/AVULSO - TM COMERCIO VAREJISTA DE OTICA LTDA',
        'CONTRIBUIÇÃO PREVIDENCIÁRIA DESCONTA SEGURADO-EMPREGADO/AVULSO - TM COMERCIO VAREJISTA DE OTICA LTDA',
        '2025-10-18'::date,
        164.35,
        1,
...
-- CP SEGURADOS - CONTRIBUINTES INDIVIDUAIS - 11% - T...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'CP SEGURADOS - CONTRIBUINTES INDIVIDUAIS - 11% - TM COMERCIO VAREJISTA DE OTICA LTDA',
        'CP SEGURADOS - CONTRIBUINTES INDIVIDUAIS - 11% - TM COMERCIO VAREJISTA DE OTICA LTDA',
        '2025-10-18'::date,
        12.48,
        1,
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'CONTRIBUIÇÃO PREVIDENCIÁRIA DESCONTA SEGURADO-EMPREGADO/AVULSO - TMC COMERCIO VAREJISTA DE OTICA LTDA',
        'CONTRIBUIÇÃO PREVIDENCIÁRIA DESCONTA SEGURADO-EMPREGADO/AVULSO - TMC COMERCIO VAREJISTA DE OTICA LTDA',
        '2025-10-18'::date,
        5.8,
        1,
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'CONTRIBUIÇÃO PREVIDENCIÁRIA DESCONTA SEGURADO-EMPREGADO/AVULSO - GIOVANNA COMERCIO VAREJISTA DE OTICA LTDA',
        'CONTRIBUIÇÃO PREVIDENCIÁRIA DESCONTA SEGURADO-EMPREGADO/AVULSO - GIOVANNA COMERCIO VAREJISTA DE OTICA LTDA',
        '2025-10-18'::date,
        570.21,
        1,
...
-- CP TERCEIROS - SEBRAE - TM COMERCIO VAREJISTA DE O...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'CP TERCEIROS - SEBRAE - TM COMERCIO VAREJISTA DE OTICA LTDA',
        'CP TERCEIROS - SEBRAE - TM COMERCIO VAREJISTA DE OTICA LTDA',
        '2025-10-18'::date,
        13.14,
        1,
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'FUNDO DE GARANTIA DO TEMPO DE SERVIÇO (competência 03/2025)',
        'FUNDO DE GARANTIA DO TEMPO DE SERVIÇO (competência 03/2025)',
        '2025-10-18'::date,
        6.19,
        1,
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'FUNDO DE GARANTIA DO TEMPO DE SERVIÇO (competência 03/2025) - TMO COMERCIO VAREJISTA DE OTICA LTDA',
        'FUNDO DE GARANTIA DO TEMPO DE SERVIÇO (competência 03/2025) - TMO COMERCIO VAREJISTA DE OTICA LTDA',
        '2025-10-18'::date,
        372.64,
        1,
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'FUNDO DE GARANTIA DO TEMPO DE SERVIÇO (competência 03/2025) - TM COMERCIO VAREJISTA DE OTICA LTDA',
        'FUNDO DE GARANTIA DO TEMPO DE SERVIÇO (competência 03/2025) - TM COMERCIO VAREJISTA DE OTICA LTDA',
        '2025-10-18'::date,
        6.22,
        1,
...
-- CP TERCEIROS - SALÁRIO EDUCAÇÃO  - TMC COMERCIO VA...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'CP TERCEIROS - SALÁRIO EDUCAÇÃO  - TMC COMERCIO VAREJISTA DE OTICA LTDA',
        'CP TERCEIROS - SALÁRIO EDUCAÇÃO  - TMC COMERCIO VAREJISTA DE OTICA LTDA',
        '2025-10-18'::date,
        1.93,
        1,
...
-- CP TERCEIROS - INCRA - TM COMERCIO VAREJISTA DE OT...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'CP TERCEIROS - INCRA - TM COMERCIO VAREJISTA DE OTICA LTDA',
        'CP TERCEIROS - INCRA - TM COMERCIO VAREJISTA DE OTICA LTDA',
        '2025-10-18'::date,
        4.38,
        1,
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'CP SEGURADOS - CONTRIBUINTES INDIVIDUAIS - 11% - TMO COMERCIO VAREJISTA DE OTICA LTDA',
        'CP SEGURADOS - CONTRIBUINTES INDIVIDUAIS - 11% - TMO COMERCIO VAREJISTA DE OTICA LTDA',
        '2025-10-18'::date,
        361.93,
        1,
...
-- CP TERCEIROS - SEBRAE  - TMC COMERCIO VAREJISTA DE...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'CP TERCEIROS - SEBRAE  - TMC COMERCIO VAREJISTA DE OTICA LTDA',
        'CP TERCEIROS - SEBRAE  - TMC COMERCIO VAREJISTA DE OTICA LTDA',
        '2025-10-18'::date,
        0.46,
        1,
...
-- CP TERCEIROS - INCRA - TMC COMERCIO VAREJISTA DE O...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'CP TERCEIROS - INCRA - TMC COMERCIO VAREJISTA DE OTICA LTDA',
        'CP TERCEIROS - INCRA - TMC COMERCIO VAREJISTA DE OTICA LTDA',
        '2025-10-18'::date,
        0.15,
        1,
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'VALE TRANSPORTE: Cleberson Ribeiro de Jesus (ref. 15/04 e 17/04/2025 - dias trabalhados > MAUÁ e SUZANO) > PIX: 517.291.608-32 (CPF) - Giovanna Mello de Camargo > NUBANK',
        'VALE TRANSPORTE: Cleberson Ribeiro de Jesus (ref. 15/04 e 17/04/2025 - dias trabalhados > MAUÁ e SUZANO) > PIX: 517.291.608-32 (CPF) - Giovanna Mello de Camargo > NUBANK',
        '2025-10-18'::date,
        20.0,
        1,
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'SALÁRIO: Cleberson Ribeiro de Jesus (ref. 3 dias trabalhados > 15/04 - 17/04/2025) > PIX: 517.291.608-32 (CPF) - Giovanna Mello de Camargo > NUBANK',
        'SALÁRIO: Cleberson Ribeiro de Jesus (ref. 3 dias trabalhados > 15/04 - 17/04/2025) > PIX: 517.291.608-32 (CPF) - Giovanna Mello de Camargo > NUBANK',
        '2025-10-18'::date,
        240.0,
        1,
...
-- SALÁRIO: Pedro Henrique (ref. 1 dia trabalhado > 1...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'SALÁRIO: Pedro Henrique (ref. 1 dia trabalhado > 16/04/2025) > PIX: 517.291.608-32 (CPF) - Giovanna Mello de Camargo > NUBANK',
        'SALÁRIO: Pedro Henrique (ref. 1 dia trabalhado > 16/04/2025) > PIX: 517.291.608-32 (CPF) - Giovanna Mello de Camargo > NUBANK',
        '2025-10-18'::date,
        80.0,
        1,
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'ACORDO: COLÉGIO INTEGRADO LUMBINI: Nicolly Mello de Camargo - Parcela 15/60 > PIX: 00.875.904/0001-60 (CNPJ)',
        'ACORDO: COLÉGIO INTEGRADO LUMBINI: Nicolly Mello de Camargo - Parcela 15/60 > PIX: 00.875.904/0001-60 (CNPJ)',
        '2025-10-18'::date,
        187.08,
        1,
...
-- ACORDO: SYGMA LABORATORIO OPTICO LTDA > Parcela 8/...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - KAWANE FERNANDES F SO...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - CLEOMAR DE OLIVEIRA G...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'Conciliação - PIX RECEBIDO - CLEOMAR DE OLIVEIRA GOMES',
        'Conciliação - PIX RECEBIDO - CLEOMAR DE OLIVEIRA GOMES',
        '2025-04-19'::date,
        1000.0,
        1,
...
-- RESCISÃO: Zaine de Lima Siqueira - Acordo 8/14 > P...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'RESCISÃO: Zaine de Lima Siqueira - Acordo 8/14 > PIX: 275.783.178-06 (CPF)',
        'RESCISÃO: Zaine de Lima Siqueira - Acordo 8/14 > PIX: 275.783.178-06 (CPF)',
        '2025-10-18'::date,
        1250.0,
        1,
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'VALE ADIANTAMENTO: Ariani Dias Fernandes Líbano (ref. 08/04 - 19/04/2025) > PIX: 487.287.868-07 (CPF)',
        'VALE ADIANTAMENTO: Ariani Dias Fernandes Líbano (ref. 08/04 - 19/04/2025) > PIX: 487.287.868-07 (CPF)',
        '2025-04-22'::date,
        1000.0,
        1,
...
-- Conciliação - PIX RECEBIDO - BERNARDETE SANTOS AMA...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- VALE ADIANTAMENTO: Camila Faccin Vieira (ref. 07/0...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- VALE TRANSPORTE: Camila Faccin Vieira (ref. 23/04 ...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
-- Conciliação - PIX RECEBIDO - LUCIANA RIBEIRO DA RO...
DO $$
DECLARE
    novo_lanc_id UUID := gen_random_uuid();
    plano_id_ref UUID;
...
BEGIN
    ...
    INSERT INTO lancamentos (
        ...
        plano_id_ref,
        NULL,
        'Conciliação - PIX RECEBIDO - LUCIANA RIBEIRO DA ROSA',
        'Conciliação - PIX RECEBIDO - LUCIANA RIBEIRO DA ROSA',
        '2025-04-22'::date,
        1000.0,
        1,
